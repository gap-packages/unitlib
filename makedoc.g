###########################################################################
##
#W makedocrel.g            The UnitLib package         Alexander Konovalov
##
###########################################################################
...
MakeGAPDocDoc( "doc",     # path to the directory containing the main file
               ...
               UNITLIBMANUALFILES, 
               "Unitlib",# the name of the book used by GAP's online help
...
GAPDocManualLab( "Unitlib" );; 
 
ExtractMyManualExamples( "unitlib", "manual.xml", UNITLIBMANUALFILES );
